...
public class ActitimeWithSleep {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Home Title validation :"+pagetitle.contains(expectedtitle));
		...
		//verify home page
		String pagetitle1=cd.getTitle();
		System.out.println("Home page title: "+pagetitle);
		String expectedtitle1="actiTIME";
		System.out.println("Home Title validation :"+pagetitle1.contains(expectedtitle1));
